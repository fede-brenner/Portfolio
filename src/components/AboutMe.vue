    ...
    <section id="about-me" class="p-0 flex items-center my-40 mx-8 text-white">
        <div id="container" class="md:grid md:grid-flow-col md:justify-between md:items-center md:gap-12 md:grid-cols-4" style="width: 1050px;">
            ...
            <div id="about-me-text" class="md:col-span-3">
                ...
                <p class="text-xl text-left">I'm a Front-End Developer. Currently studying Computer Systems Engineering at Interamerican Open University(UAI). I love the feeling of compleeting complex proyects and knowing that i learned a lot in the process.</p>
                <div id="buttons" class="flex items-center mt-12 gap-12">
                    <button id="resume-btn" class="p-3 text-2xl font-bold text-white ml-2 border-none pixel-corners bg-accent">RESUME</button>
